...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            // STEP 0: Pilih Tipe Tarikan (Agency atau VB)
            const targetResult = await askSelection(interaction, {
                stepName: 'Tipe',
                title: '🏢 Pilih Tipe Tarikan',
                placeholder: 'Pilih Agency atau VB...',
                options: [
                    { label: 'Agency', value: 'agency', description: 'Jalankan pipeline untuk folder agency' },
                    { label: 'VB (Virtual Brand)', value: 'VB', description: 'Jalankan pipeline untuk folder VB' }
                ],
                minValues: 1,
                maxValues: 1,
                isFirstStep: true,
            ...
            const aplikatorResult = await askSelection(targetResult.lastInteraction, {
                stepName: 'Aplikator',
                ...
                maxValues: 1,
                fields: [
                    { name: 'Tipe', value: target.toUpperCase(), inline: true }
                ],
                hasOutletStep: true
            });
            ...
            const getPeriodEmbed = () => {
                ...
                return makeProgressEmbed('Periode', '📅 Pilih Periode Laporan', desc, currentFields, hasOutletStep);
            };
